<template>
  <div class="layout-container">
    ...
    <div class="layout-container-table">
      ...
      >
        <el-table-column prop="name" label="经办人员" align="center" />
        <el-table-column prop="number" label="转往单位" align="center" />
        <el-table-column prop="name" label="转递时间" align="center" />
        <el-table-column prop="radioName" label="接收人员" align="center" />
        <el-table-column prop="radioName" label="档案人员" align="center" />
        <el-table-column prop="radioName" label="转递方式" align="center" />
        <el-table-column prop="radioName" label="转递类型" align="center" />
...
import dilogForm from "./forward-form.vue";
interface User {
  id: string;
  name: string;
  amount1: string;
