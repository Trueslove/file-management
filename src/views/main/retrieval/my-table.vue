<template>
  <div class="layout-container">
    ...
    <div class="layout-container-table">
      ...
      >
        <el-table-column prop="name" label="档案状态" align="center" />
        ...
        <el-table-column prop="radioName" label="参加组织日期" align="center" />
        <el-table-column prop="radioName" label="文化程度" align="center" />
        <el-table-column prop="radioName" label="现职单位及职务" align="center" />
