  ...
  <div class="layout-container">
    ...
    <div class="layout-container-table">
      ...
      >
        ...
        <el-table-column prop="number" label="整理日期" align="center" />
        <el-table-column prop="chooseName" label="正本数" align="center" />
        <el-table-column prop="radioName" label="副本数" align="center" />
        <el-table-column prop="radioName" label="整理人" align="center" />
        <el-table-column prop="radioName" label="审核人" align="center" />
    ...
    <el-dialog v-model="dialogFormVisible" width="70%" :title="dialogTit">
      <dilogForm />
    </el-dialog>
  </div>
</template>
...
import dilogForm from "./register-form.vue";
interface User {
  id: string;
  name: string;
  amount1: string;
