  ...
  <div class="layout-container">
    <div class="layout-container-form flex space-between">
      <div class="layout-container-form-handle">
        <el-button type="primary" @click="handleAddStaff">按人员登记</el-button>
        <el-button type="primary" @click="handleAdd">按材料登记</el-button>
    ...
    <div class="layout-container-table">
      ...
      >
        ...
        <el-table-column prop="chooseName" label="材料类型" align="center" />
        <el-table-column prop="radioName" label="份数" align="center" />
        <el-table-column prop="radioName" label="页数" align="center" />
        <el-table-column prop="radioName" label="材料形成日期" align="center" />
        <el-table-column prop="radioName" label="材料来源" align="center" />
        <el-table-column prop="radioName" label="备注" align="center" />
      </Table>
      <Layer :layer="layer" @getTableData="getTableData" v-if="layer.show" />
    </div>
    <el-dialog v-model="isShowStaff" width="70%" :title="dialogTit">
      <dilogStaff />
    </el-dialog>
    <el-dialog v-model="isShowMaterial" width="70%" :title="dialogTit">
      <dilogForm />
    </el-dialog>
  </div>
</template>
...
import dilogStaff from "./material-staff.vue";
import dilogForm from "./material-form.vue";
interface User {
  id: string;
  name: string;
  amount1: string;
